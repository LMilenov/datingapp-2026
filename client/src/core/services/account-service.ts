...
export class AccountService {
  ...
  private presencseService = inject(PresenceService);
  ...
  setCurrentUser(user: User) {
    ...
    if (this.presencseService.hubConnection?.state !== HubConnectionState.Connected) {
      this.presencseService.createHubConnection(user)
    }
  }
  ...
  logout() {
    this.http.post(this.baseUrl + 'account/logout', {}, { withCredentials: true}).subscribe({
      next: () => {
        ...
        this.presencseService.stopHubConnection();
      }
    })
  }
